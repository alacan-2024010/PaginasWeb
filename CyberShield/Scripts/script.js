...
function startSecurityScan() {
    ...
    // Obtener tipo de scan seleccionado
    const scanType = document.querySelector('input[name="scanType"]:checked').value;
    const scanDuration = getScanDuration(scanType);
    
    // Inicializar output del terminal
...
function getScanDuration(scanType) {
    switch(scanType) {
        case 'quick': return 15000; // 15 segundos
        case 'full': return 30000;  // 30 segundos
        case 'custom': return 20000; // 20 segundos
...
function displayScanResults(results) {
    ...
    // Actualizar colores según resultados
